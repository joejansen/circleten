...
function scene:enterScene( event )
	...
	local movesNum = 12
	local goalNum = 2
	local cueBallStartX = display.screenOriginX + 15
	local cueBallStartY = 60
...
----------------OPTIONS
	...
	local orangeWall1 = gameLogic.createOrangeWall(display.screenOriginX,middleStageY-70,floorRoofWidth-60,1)
		wallGroup:insert(orangeWall1)

		local orangeWall2 = gameLogic.createOrangeWall(display.screenOriginX,middleStageY+70,floorRoofWidth-60,1)
			wallGroup:insert(orangeWall2)


		local redWidth = floorRoofWidth - 60
		
		local redWall1 = gameLogic.createRedWall(rightXBound-redWidth,middleStageY,redWidth,1)	
	...
	-- 
	local specificStageBall1 = gameLogic.createSpecificStageBall(5,display.screenOriginX+15,middleStageY)
	allball:insert(specificStageBall1)
	
	local specificStageBall2 = gameLogic.createSpecificStageBall(5,rightXBound-15,middleStageY+70)
	allball:insert(specificStageBall2)

	local specificStageBall3 = gameLogic.createSpecificStageBall(5,display.screenOriginX+15,middleStageY+100)
	allball:insert(specificStageBall3)
	
	local specificStageBall4 = gameLogic.createSpecificStageBall(5,rightXBound-15,middleStageY-70)
