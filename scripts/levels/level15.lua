...
----------------OPTIONS
	...
	-- 	
		local redWall1 = gameLogic.createRedWall(0,0 ,floorRoofWidth-105,1)
		redWall1:setReferencePoint(display.CenterReferencePoint)
		redWall1.x = middleStageX
		redWall1.y = middleStageY-50
		wallGroup:insert(redWall1)
	-- 	
	-- 	gameLogic.createBlueWall(display.screenOriginX,halfH,floorRoofWidth,4)
	
	local randStageBalls1 = gameLogic.createRandStageBallsXY(15,1,9,display.screenOriginX+10,2*middleStageX-15,roofHeight+15,middleStageY-60)
...
---------------------------------------------------------------------------------------	
	...
	local hint = display.newText("Red walls are very bouncy - Be careful!",display.screenOriginX+10,middleStageY-40,floorRoofWidth-20,100,"HelveticaNeue", 20)
