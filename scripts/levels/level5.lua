...
function scene:enterScene( event )
	...
	local movesNum = 12
	local goalNum = 2
	local cueBallStartX = floorRoofWidth*.5
	local cueBallStartY = 250
...
----------------OPTIONS
	...
	local orangeWall1 = gameLogic.createOrangeWall(70,roofHeight,1,150)
	wallGroup:insert(orangeWall1)
	
	local orangeWall2 = gameLogic.createOrangeWall(70,roofHeight+150,250,1)
	...
	-- 
	local specificStageBall1 = gameLogic.createSpecificStageBall(7,115,55)
	allball:insert(specificStageBall1)
	
	local specificStageBall2 = gameLogic.createSpecificStageBall(3,17,55)
	allball:insert(specificStageBall2)
	
	local specificStageBall3 = gameLogic.createSpecificStageBall(7,125,55)
	allball:insert(specificStageBall3)
	
	local specificStageBall4 = gameLogic.createSpecificStageBall(3,21,55)
