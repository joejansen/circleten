...
----------------OPTIONS
	...
	-- 
	local specificStageBall1 = gameLogic.createSpecificStageBall(8,350,150)
	allball:insert(specificStageBall1)
	
	local specificStageBall2 = gameLogic.createSpecificStageBall(3,350,200)
	allball:insert(specificStageBall2)
	
	local specificStageBall3 = gameLogic.createSpecificStageBall(5,350,250)
...
---------------------------------------------------------------------------------------	
	...
	local hint = display.newText("The Plus/Minus button toggles between addition and subtraction",display.screenOriginX+15,display.screenOriginY+35,floorRoofWidth-20,100,"HelveticaNeue", 20)
