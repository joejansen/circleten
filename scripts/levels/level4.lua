...
----------------OPTIONS
	...
	local oneThird = (floorRoofWidth )/3
	local oneSixth = (floorRoofWidth )/6

	local orangeWall1 = gameLogic.createOrangeWall(display.screenOriginX+oneThird,roofHeight,1,200)
	wallGroup:insert(orangeWall1)

	local orangeWall2 = gameLogic.createOrangeWall(display.screenOriginX+2*oneThird,maxVisibleY-200,1,200)
	...
	-- local randStageBalls1 = gameLogic.createRandStageBalls(20,1,9)
	-- allball:insert(randStageBalls1)
	-- 
	local specificStageBall1 = gameLogic.createSpecificStageBall(8,display.screenOriginX+5*oneSixth,middleStageY)
	allball:insert(specificStageBall1)
	
	local specificStageBall2 = gameLogic.createSpecificStageBall(1,display.screenOriginX+oneSixth,middleStageY+10)
...
---------------------------------------------------------------------------------------	
	...
	local hint = display.newText("Avoid the walls",orangeWall1.x+15,display.screenOriginY+35,"HelveticaNeue", 20)
