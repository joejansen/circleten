...
----------------OPTIONS
	...
	-- 
	local specificStageBall1 = gameLogic.createSpecificStageBall(7,middleStageX+130,middleStageY)
	allball:insert(specificStageBall1)
	
	local specificStageBall2 = gameLogic.createSpecificStageBall(3,middleStageX-130,middleStageY)
...
---------------------------------------------------------------------------------------	
	...
	local hint = display.newText("Add balls for one combination of 10",display.screenOriginX+15,display.screenOriginY+35,"HelveticaNeue", 20)
