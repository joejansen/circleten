...
----------------OPTIONS
	...
	-- purpleWall1 = gameLogic.createPurpleWall(rightXBound-100,maxVisibleY-175,3,150)
	-- 
	-- purpleRotation = function()
	-- 	purpleWall1.rotation = purpleWall1.rotation + 5
	-- end
	-- 
	-- Runtime:addEventListener( "enterFrame", purpleRotation )
	
	local greenWall1 = gameLogic.createGreenWall(display.screenOriginX,maxVisibleY-125,125,1)	
	wallGroup:insert(greenWall1)

	local greenWall2 = gameLogic.createGreenWall(middleStageX+(floorRoofWidth/4),maxVisibleY-125,1,125)	
	...
	-- allball:insert(randStageBalls1)
	-- 
	local specificStageBall1 = gameLogic.createSpecificStageBall(6,rightXBound-20,maxVisibleY-20)
	allball:insert(specificStageBall1)
	-- 
	local specificStageBall1 = gameLogic.createSpecificStageBall(4,display.screenOriginX+50,maxVisibleY-20)
	allball:insert(specificStageBall1)
---------------------------------------------------------------------------------------
---------------------------------------------------------------------------------------	
	allball.alpha = 0
