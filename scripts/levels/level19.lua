...
----------------OPTIONS
	...
	local specificStageBall5 = gameLogic.createSpecificStageBall(6,middleStageX - 150,middleStageY+100)
...
---------------------------------------------------------------------------------------	
	...
	-- group:insert(hint1)
	specificStageBall5:applyLinearImpulse(0,1,specificStageBall5.x,specificStageBall5.y)
	specificStageBall6:applyLinearImpulse(0,1,specificStageBall6.x,specificStageBall6.y)
	specificStageBall7:applyLinearImpulse(0,-1,specificStageBall7.x,specificStageBall7.y)
