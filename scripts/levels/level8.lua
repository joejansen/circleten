...
----------------OPTIONS
	...
	-- 
	local specificStageBall1 = gameLogic.createSpecificStageBall(7,120,150)
	allball:insert(specificStageBall1)
	
	local specificStageBall2 = gameLogic.createSpecificStageBall(7,200,80)
	allball:insert(specificStageBall2)
	
	local specificStageBall3 = gameLogic.createSpecificStageBall(4,120,250)
