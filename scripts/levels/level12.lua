...
----------------OPTIONS
	...
	-- 
	gameLogic.createBlueWall(display.screenOriginX,150,floorRoofWidth,1)

	local randStageBalls1 = gameLogic.createRandStageBallsXY(15,1,9,display.screenOriginX+10,2*middleStageX-15,middleStageY+15,maxVisibleY-10)
	allball:insert(randStageBalls1)
---------------------------------------------------------------------------------------
---------------------------------------------------------------------------------------	
	allball.alpha = 0
	...
	local hint = display.newText("Blue walls flash",display.screenOriginX+15,120,floorRoofWidth-20,100,"HelveticaNeue", 20)
