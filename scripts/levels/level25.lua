...
function scene:enterScene( event )
	...
	local movesNum = 7
	local goalNum = 2
	local cueBallStartX = middleStageX-100
...
----------------OPTIONS
	...
	-- 	
	local wallHeight = maxVisibleY-roofHeight-5
	
	local yellowWall1 = gameLogic.createYellowWall(middleStageX+50,roofHeight+2,1,wallHeight)	
	...
	local randStageBalls1 = gameLogic.createRandStageBallsXY(20,1,9,middleStageX+60,rightXBound-20,roofHeight+15,230)
...
---------------------------------------------------------------------------------------	
	...
	local hint = display.newText("Yellow lines can be knocked out of your way",display.screenOriginX+15,display.screenOriginY+35,"HelveticaNeue", 20)
