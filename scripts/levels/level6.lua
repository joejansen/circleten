...
function scene:enterScene( event )
	...
	local movesNum = 8
	local goalNum = 1
	local cueBallStartX = middleStageX + 50
	local cueBallStartY = 100
...
----------------OPTIONS
	...
	local orangeWall1 = gameLogic.createOrangeWall(middleStageX,roofHeight,1,210)
	...
	local randStageBalls1 = gameLogic.createRandStageBallsXY(15,1,9,5,200,45,200)
	allball:insert(randStageBalls1)
	-- 
	-- local specificStageBall1 = gameLogic.createSpecificStageBall(7,halfW+130,halfH)
	-- allball:insert(specificStageBall1)
	-- 
	-- local specificStageBall2 = gameLogic.createSpecificStageBall(3,halfW-130,halfH)
