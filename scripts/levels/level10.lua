...
----------------OPTIONS
	...
	-- 
	local specificStageBall1 = gameLogic.createSpecificStageBall(1,75,275)
...
---------------------------------------------------------------------------------------	
	...
	local hint = display.newText("The More Balls button adds 3 balls, but cost one move",display.screenOriginX+15,display.screenOriginY+35,floorRoofWidth-20,100,"HelveticaNeue", 20)
