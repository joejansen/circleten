...
----------------OPTIONS
	...
	-- 
	local specificStageBall1 = gameLogic.createSpecificStageBall(9,display.screenOriginX+oneSixth,middleStageY)
	allball:insert(specificStageBall1)
	
	local specificStageBall2 = gameLogic.createSpecificStageBall(5,display.screenOriginX+5*oneSixth,middleStageY+50)
	allball:insert(specificStageBall2)
	
	local specificStageBall3 = gameLogic.createSpecificStageBall(6,display.screenOriginX+oneSixth,middleStageY-50)
