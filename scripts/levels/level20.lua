...
function scene:enterScene( event )
	...
	local cueBallStartY = middleStageY+100
...
----------------OPTIONS
	...
	local orangeWall1 = gameLogic.createOrangeWall(middleStageX-150,middleStageY,1,maxVisibleY/2)
		wallGroup:insert(orangeWall1)
		
		local orangeWall2 = gameLogic.createOrangeWall(middleStageX+150,middleStageY,1,maxVisibleY/2)
	...
	-- 	
		...
		-- 
		-- local greenWall3 = gameLogic.createGreenWall(display.screenOriginX,middleStageY-50,floorRoofWidth,1)	
		-- wallGroup:insert(greenWall3)
		-- 
		-- local greenWall4 = gameLogic.createGreenWall(display.screenOriginX,middleStageY-100,floorRoofWidth,1)	
	...
	local specificStageBall4 = gameLogic.createSpecificStageBall(2,middleStageX + 175,300)
	allball:insert(specificStageBall4)
	
	local specificStageBall5 = gameLogic.createSpecificStageBall(8,middleStageX - 175,300)
