...
----------------OPTIONS
	...
	local yellowWidth = floorRoofWidth - 200
	...
	-- allball:insert(randStageBalls1)
	-- 
	local specificStageBall1 = gameLogic.createSpecificStageBall(1,rightXBound-20,maxVisibleY-20)
