...
----------------OPTIONS
	...
	local specificStageBall1 = gameLogic.createSpecificStageBall(5,middleStageX+130,middleStageY-60)
	allball:insert(specificStageBall1)
	
	local specificStageBall2 = gameLogic.createSpecificStageBall(5,middleStageX-130,middleStageY-60)
	allball:insert(specificStageBall2)
	
	local specificStageBall3 = gameLogic.createSpecificStageBall(5,middleStageX+130,middleStageY+60)
	allball:insert(specificStageBall3)
	
	local specificStageBall4 = gameLogic.createSpecificStageBall(5,middleStageX-130,middleStageY+60)
...
---------------------------------------------------------------------------------------	
	...
	local hint = display.newText("Now add for two combinations of 10",display.screenOriginX+15,display.screenOriginY+35,"HelveticaNeue", 20)
