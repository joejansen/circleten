...
----------------OPTIONS
	...
	local orangeWall1 = gameLogic.createOrangeWall(middleStageX,roofHeight,1,100)
	wallGroup:insert(orangeWall1)
		
		
	local orangeWall2 = gameLogic.createOrangeWall(middleStageX,maxVisibleY-100,1,100)
