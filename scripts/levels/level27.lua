...
----------------OPTIONS
	...
	local orangeWall1 = gameLogic.createOrangeWall(display.screenOriginX,roofHeight+oneFourthY,floorRoofWidth-120,1)
	wallGroup:insert(orangeWall1)

	local yellowWall1 = gameLogic.createYellowWall(middleStageX,roofHeight+2,1,oneFourthY-3)	
	wallGroup:insert(yellowWall1)
	
	local yellowWall2 = gameLogic.createYellowWall(yellowWall1.x,orangeWall1.y-1,oneFourthY-3,1)	
	wallGroup:insert(yellowWall2)
	
	physics.newJoint( "weld", yellowWall1, yellowWall2, yellowWall1.x, yellowWall2.y )
	
	local yellowWall3 = gameLogic.createYellowWall(yellowWall1.x+oneFourthY-3,roofHeight+2,1,oneFourthY-3)	
	wallGroup:insert(yellowWall3)
	
	physics.newJoint( "weld", yellowWall3, yellowWall2, yellowWall3.x, yellowWall2.y )
	
	local specificStageBall1 = gameLogic.createSpecificStageBall(5,yellowWall1.x+35,roofHeight+30)
	allball:insert(specificStageBall1)
	
	local greenWall1 = gameLogic.createGreenWall(yellowWall1.x,roofHeight+2,oneFourthY-3,1)
	greenWall1.bodyType = "dynamic"	
	wallGroup:insert(greenWall1)
	
	physics.newJoint( "weld", yellowWall1, greenWall1, yellowWall1.x, greenWall1.y )
	
	local orangeWall2 = gameLogic.createOrangeWall(display.screenOriginX+100,roofHeight+3*oneFourthY,floorRoofWidth-200,1)
	wallGroup:insert(orangeWall2)
	
	
	local yellowWall4 = gameLogic.createYellowWall(middleStageX-oneFourthY*.5,orangeWall2.y+2,1,oneFourthY-3)	
	wallGroup:insert(yellowWall4)
	
	local yellowWall5 = gameLogic.createYellowWall(yellowWall4.x,maxVisibleY-1,oneFourthY-3,1)	
	wallGroup:insert(yellowWall5)
	
	physics.newJoint( "weld", yellowWall4, yellowWall5, yellowWall4.x, yellowWall5.y )
	
	local yellowWall6 = gameLogic.createYellowWall(yellowWall4.x+oneFourthY-3,orangeWall2.y+2,1,oneFourthY-3)	
	wallGroup:insert(yellowWall6)
	
	physics.newJoint( "weld", yellowWall6, yellowWall5, yellowWall6.x, yellowWall5.y )
	
	local specificStageBall2 = gameLogic.createSpecificStageBall(5,yellowWall4.x+35,orangeWall2.y+30)
	allball:insert(specificStageBall2)
	
	local greenWall2 = gameLogic.createGreenWall(yellowWall4.x,orangeWall2.y+2,oneFourthY-3,1)
	greenWall2.bodyType = "dynamic"	
	wallGroup:insert(greenWall2)
	
	physics.newJoint( "weld", yellowWall4, greenWall2, yellowWall4.x, greenWall2.y )
	
	-- local greenWall1 = gameLogic.createGreenWall(display.screenOriginX,middleStageY+50,floorRoofWidth,1)	
	-- wallGroup:insert(greenWall1)
