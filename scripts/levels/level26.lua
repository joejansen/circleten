...
function scene:enterScene( event )
	...
	local movesNum = 5
	local goalNum = 1
	local cueBallStartX = middleStageX+125
	local cueBallStartY = middleStageY+75
...
----------------OPTIONS
	...
	-- 	
	local yellowWall1 = gameLogic.createYellowWall(middleStageX+50,roofHeight+5,1,150)	
	wallGroup:insert(yellowWall1)
	
	local yellowWall2 = gameLogic.createYellowWall(middleStageX+50,roofHeight+155,150,1)	
	wallGroup:insert(yellowWall2)
	
	local yellowWall3 = gameLogic.createYellowWall(middleStageX+200,roofHeight+5,1,150)	
	wallGroup:insert(yellowWall3)
	
	local greenWall1 = gameLogic.createGreenWall(middleStageX+50,roofHeight+5,150,1)
	greenWall1.bodyType = "dynamic"	
	wallGroup:insert(greenWall1)
	
	local greenWall2 = gameLogic.createGreenWall(middleStageX+50,roofHeight+25,150,1)
	greenWall2.bodyType = "dynamic"	
	wallGroup:insert(greenWall2)
	
	physics.newJoint( "weld", yellowWall1, yellowWall2, middleStageX+50, roofHeight+155 )
	
	physics.newJoint( "weld", yellowWall2, yellowWall3, middleStageX+200, roofHeight+155 )
	
	physics.newJoint( "weld", yellowWall1, greenWall1, middleStageX+50,roofHeight+5 )
	
	physics.newJoint( "weld", yellowWall1, greenWall2, middleStageX+50,roofHeight+25 )
	
	-- local yellowWall2 = gameLogic.createYellowWall(middleStageX+30,roofHeight+2,1,wallHeight)	
	-- wallGroup:insert(yellowWall2)
	
	-- local yellowWall3 = gameLogic.createYellowWall(middleStageX+10,roofHeight+2,1,wallHeight)	
	-- wallGroup:insert(yellowWall3)
	...
	-- 
	local specificStageBall1 = gameLogic.createSpecificStageBall(6,middleStageX+90,roofHeight+65)
	allball:insert(specificStageBall1)
	
	local specificStageBall2 = gameLogic.createSpecificStageBall(4,middleStageX+120,roofHeight+65)
